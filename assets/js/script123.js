...
function storeEntry() {
  localStorage.event1 = $("#colorCoded1").html()
  $("colorCoded1").html(localStorage.text)
  localStorage.event2 = $("#colorCoded2").html()
  $("colorCoded2").html(localStorage.text)
...
localStorage.get(event1);
localStorage.get(event2);
...
var pullEvents = [event1, event2];
for(i = 0; i < pullEvents.length; i++) {
    $("#colorCoded1").text(event1);
    $("#colorCoded2").text(event2);
